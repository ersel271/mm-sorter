...
def _cfg(valid_data, tmp_path, colours=None):
...
class TestColourClassificationRule:
    ...
    def test_clear_colour_match_returns_label(self, valid_data, tmp_path):
        cfg = _cfg(valid_data, tmp_path)
    ...
    def test_sv_gate_fail_returns_no_fire(self, valid_data, tmp_path):
        cfg = _cfg(valid_data, tmp_path)
        rule = ColourClassificationRule(cfg)
    ...
    def test_low_confidence_returns_no_fire(self, valid_data, tmp_path):
        cfg = _cfg(valid_data, tmp_path)
        rule = ColourClassificationRule(cfg)
    ...
    def test_ambiguity_returns_non_mm(self, valid_data, tmp_path):
        cfg = _cfg(valid_data, tmp_path)
        rule = ColourClassificationRule(cfg)
    ...
    def test_clear_winner_is_not_ambiguous(self, valid_data, tmp_path):
        cfg = _cfg(valid_data, tmp_path)
        rule = ColourClassificationRule(cfg)
    ...
    def test_val_gate_fail_returns_no_fire(self, valid_data, tmp_path):
